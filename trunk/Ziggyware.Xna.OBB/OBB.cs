...
namespace Ziggyware.Xna
{
    
    public class OBB
    {
        public Color[] Colors = new Color[8];
        public bool[] CollisionVerts = new bool[8];
        ...
        public OBB() : this(Vector3.Zero, Vector3.One, Matrix.Identity)
        {
        }

        public OBB(Vector3 center, Vector3 bounds) : this(center, bounds, Matrix.Identity)
        {
        }
