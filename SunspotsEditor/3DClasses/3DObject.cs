...
namespace SunspotsEditor
{
    ...
    public class Obj3d : CollisionObject
    {
        ...
        public Obj3d(Model model, String ContentName)
        {
            setUp(model, Vector3.Zero, Vector3.Zero, ContentName, null);
        }
        ...
        public Obj3d(Model model, Vector3 position, Vector3 rotation, String ContentName)
        {

            setUp(model, position, rotation, ContentName, null);
        }
        ...
        public Obj3d(Model model, Vector3 position, Vector3 rotation, String ContentName, OBB[] BoundingBoxes)
        {
            setUp(model, position, rotation, ContentName, BoundingBoxes);
        }
        /// <summary>
        /// setup the 3d object
        /// </summary>
        ...
        public Obj3d(Model model, Vector3 position, Vector3 rotation, String ContentName, OBB boundingbox)
        {
            OBB[] boxes = new OBB[1];
            boxes[0] = boundingbox;
            setUp(model, position, rotation, ContentName, boxes);
        }




        private void setUp(Model model, Vector3 position, Vector3 rotation, String ContentName, OBB[] BoundingBoxes)
        {
            Object = model;
